...
echo $item1; ?></textarea><a class="delete" href="javascript:;" title="Remove row">X</a></div></td>
		      <td class="description" ><textarea name="category1">
<?php
...
$result=pg_query($connection, "Select cat_name from product,category where product_name='$item1' AND product.cat_id=category.cat_id");
	if  (!$result) {
